...
<div class="screen active" id="game-screen">
  ...
  <div class="game-bottom-bar">
    ...
    {#if store.botThinking}
      <div class="bot-thinking-spinner" aria-label="AI 思考中">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(200,169,110,0.8)" stroke-width="2.5">
